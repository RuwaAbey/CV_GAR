...
class ZiT(nn.Module):
    def __init__(self, in_channels=3, num_person=12, num_point=17, num_head=6, graph=None, graph_args=dict()):
        ...
        self.l4 = TCN_STRANSF_unit(48, 96, num_point=num_point, heads=num_head, stride=2, mask=self.A, mask_grad=False)
        self.l5 = TCN_STRANSF_unit(96, 96, num_point=num_point, heads=num_head, mask=self.A, mask_grad=False)
        self.l6 = TCN_STRANSF_unit(96, 192, num_point=num_point, heads=num_head, stride=2, mask=self.A, mask_grad=False)
        self.l7 = TCN_STRANSF_unit(192, 192, num_point=num_point, heads=num_head, mask=self.A, mask_grad=False)
